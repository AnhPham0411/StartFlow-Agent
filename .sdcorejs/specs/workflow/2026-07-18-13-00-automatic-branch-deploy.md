...
description: Deploy StartFlow from the same branch commit only after all CI gates pass.
contract_id: workflow-automatic-branch-deploy-v1
requirement_id: req-workflow-automatic-branch-deploy-20260718
approvedAt: 2026-07-18T13:00:46+07:00
...
sourceDraftPath: .sdcorejs/docs/workflow/2026-07-18-12-59-automatic-branch-deploy-spec.md
...
# Automatic branch-aware deployment - Approved Spec
...
- Approved as drafted; user selected the reusable workflow approach and explicitly approved the spec.
