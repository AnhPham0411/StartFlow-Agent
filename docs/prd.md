...
Đội thi cần một trải nghiệm bán hàng có thể demo trong thời gian ngắn nhưng vẫn bám hạ tầng thật: Keycloak, PostgreSQL, Qdrant, Next.js, NestJS và Python AI service. Sales Copilot mở rộng StartFlow bằng bộ hồ sơ khách hàng demo và luồng NBA có kiểm soát quyền.
...
6. Các trang call list, customers, customer detail và admin build thành công.
...
- Đăng nhập thành công và mở NBA UI trong một phiên trình diễn.
