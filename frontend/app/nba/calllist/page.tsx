    ...
    <>
      ...
      {!loading && !error && rows.length === 0 && (
        <div className="banner banner--info">
          ...
          <p>
            Không có khách nào trong call list ngày {date}. Thử chọn ngày khác hoặc liên hệ quản lý
            để được phân công.
          </p>
        </div>
      )}
                  ...
                  {row.product_rank1 ? (
                    <>
                      <span className="offer offer--top">
                        ...
                        {typeof row.score_rank1 === 'number' &&
                          ` · ${(row.score_rank1 * 100).toFixed(0)}%`}
                      </span>
                      {row.product_rank2 && (
                        <span className="offer">
                          {PROD[row.product_rank2] ?? row.product_rank2}
                        </span>
                      )}
                    </>
                  ) : (
              ...
              {status ? (
                ...
                <div className="call-row__actions">
                  ...
                  <button
                    ...
                    className="act"
                    disabled={busy}
                    onClick={() => void record(row, 'no_contact')}
        ...
        >
          <div className="modal">
            ...
            <div className="modal__body">
              <label className="fieldset-label" htmlFor="reason">
                Chọn lý do
              </label>
              <select
                id="reason"
